			...
			<div id="page">
				<div class="container">
					<div class="row">
                            ...
                            ResultSet rs=db.Select("select * from user_phr_details where  Aadhar_No='"+ano+"'");
                            %>
                            <div >
                                <center>
                                    <br>
                            ...
                            while(rs.next())
                            {
                              %>
                              <tr>
                                  <td><center><%=rs.getString("inputDate")%></center></td>
                                    <td><center><%=rs.getString("allergy")%></center></td>
                                     <td><center><%=rs.getString("U_Name")%></center></td>
                                      <td><center><%=rs.getString("U_Id")%></center></td>
