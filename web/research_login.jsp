			...
			<div id="page">
				<div class="container">
                    ...
                    <section id="content">
							  ...
							  <form action="research_login" method="post" onsubmit="return Validate_Data(this)">
                                  <a class="navbar-brand d-none d-lg-block">RESEARCH LOGIN</a> 
                                                            <br>
                        ...
                        <center>
                            ...
                            <section id="content" >
                               ...
                               RESEARCH LOGIN
                                    ...
                                    <!--<center><font face="Georgia" color="#0C6E69"><h4>RESEARCH LOGIN</h4></font><br>
                                        <br>
