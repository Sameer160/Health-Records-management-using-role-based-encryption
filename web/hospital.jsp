				...
				<div class="container"> 
					...
					<nav id="nav">
						<ul>
							...
							<li class="active"><a href="index.jsp">Hospital</a></li>
							<li><a href="banking.jsp">Banking</a></li>
							<li><a href="insurance.jsp">Insurance</a></li>
							<li><a href="researcher.jsp">Researcher</a></li>
			...
			<div id="page">
				<div class="container">
					<div class="row">
							...
							<section id="content" >
								 <a><img src="images/123.jpg" title="logo" style="width: 1000px; margin-left: 133px; height: 400px;"/></a>                 
