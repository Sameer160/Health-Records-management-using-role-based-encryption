...
int uid=Integer.parseInt(request.getParameter("name"));
...
psmnt = con.prepareStatement("SELECT image FROM provider_details WHERE S_No =?");
psmnt.setInt(1, uid); // here integer number 'fff' is image id from the table
