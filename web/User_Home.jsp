<%-- 
    Document   : User_Home
    Created on : 17 Feb, 2025, 4:06:40 PM
                                ...
                                <h1 class="mt-auto mb-2">
                                  Aadhar  Card
                                    <div class="animated-info">
                                        ...
                                        <span class="animated-item">Records</span>
                                        <span class="animated-item">Monitor</span>
                                    </div>
                                </h1>

                                <p class="mb-4">Based Health Records Monitoring System.</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12 ms-auto mt-4 mt-lg-0">
                        <p class="copyright-text">Copyright © Aadhar Card Based Health Records 2021 
