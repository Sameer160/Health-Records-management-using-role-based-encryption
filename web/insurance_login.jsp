			...
			<div id="page">
				<div class="container">
                    ...
                    <section id="content">
							 ...
							 <form action="insurance_login" method="post" onsubmit="return Validate_Data(this)">
                                  <a class="navbar-brand d-none d-lg-block">INSURANCE LOGIN</a> 
                                                            <br>
                            ...
                            <table>
                                <tr>
                                    <td class="input-group">
                                        ...
                                        <input type="text" value="" id="hname" name="i_name">
                                        <div class="error"></div>
                                    </td>
                                </tr>                                 
                        ...
                        <center>
                            ...
                            <section id="content" >
                               ...
                               INSURANCE LOGIN
                                    ...
                                    <!--<center><font face="Georgia" color="#0C6E69"><h4>INSURANCE LOGIN</h4></font><br>
                                        <br>

                                        <Center><table border="3">
                                            <tr><td><font face="Georgia" color="black"> Insured Name</font></td><td>:</td><td><input type="text" value="" id="hname" name="i_name" style="width: 204px;" ></td></tr>
