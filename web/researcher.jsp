            ...
            <div id="page">
                ...
                <center>
                    <section id="content">
                      ...
                      <form action="research_reg" method="post" enctype="multipart/form-data" onsubmit="return Validate_Data(this)">
                            <table>
                                <tr>
                                    <td class="input-group">
                                        <label for="Research Name"> Research Name</label>
                                        <input type="text" value="" id="hname" name="R_Name">
                                        <div class="error"></div>
                                    </td>
                                </tr>                       
                                <tr>
...
<input type="password" value="" id="rpass" name="C_Pass">
 <div class="error"></div>
                                 ...
                                 <tr>                         
 <td class="input-group">
<label for="Work Experiance">Work Experiance</label>
<input type="text" value="" id="hname" name="W_Experi">
 <div class="error"></div>
 </td>
                                </tr> 
                                 <tr>                         
...
<input type="text" value="" id="hname" name="speci">
 <div class="error"></div>
 </td>
                                </tr> 
                                <tr>                            
...
<input type="file" value="" id="yer" name="file" maxlength="4"  onkeypress="return number(event)" maxlength="4" >
 <div class="error"></div>
                            ...
                            <button type="submit">Register</button>&nbsp;&nbsp;&nbsp;<a href="research_login.jsp"><font face="Georgia" color="blue">LOGIN</font
                                            ></a>
                        </form>
                        ...
                        <center>
                            ...
                            <section id="content" >
                               ...
                               RESEARCH REGISTRATION
                                    ...
                                    <!--<center><font face="Georgia" color="#0C6E69"><h4>RESEARCH REGISTRATION</h4></font><br>
                                        <br>

                                        <table border="3">
                                            <tr><td><font face="Georgia" color="black"> Research Name:</font></td><td>:</td><td><input type="text" value="" id="hname" name="R_Name" style="width: 204px;" ></td></tr>
                                            ...
                                            <tr><td><font face="Georgia" color="black"> Work Experiance:</font></td><td>:</td><td><input type="text" value="" id="hname" name="W_Experi" style="width: 204px;" ></td></tr>
                                            <tr><td><font face="Georgia" color="black"> Specialization:</font></td><td>:</td><td><input type="text" value="" id="hname" name="speci" style="width: 204px;" ></td></tr>
                                        ...
                                        <br><br>
                                        <input type="submit" value="Register" > &nbsp;&nbsp;&nbsp;<a href="research_login.jsp"><font face="Georgia" color="blue">LOGIN</font
                                            ></a>  </center>
                                </form>-->
                                <%
