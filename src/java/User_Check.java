...
public class User_Check extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ResultSet rs=db.Select("Select * from User_Registration where U_name='"+name+"' and U_Pass='"+pass+"'");
            System.out.println("Select * from User_Registration where U_name='"+name+"' and U_Pass='"+pass+"'");
            if(rs.next())
            {
