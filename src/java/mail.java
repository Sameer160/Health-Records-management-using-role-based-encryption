...
ResultSet rs=Db.Select("select * from user_registration where A_Name='"+id1+"'");
if(rs.next())
{
     t=rs.getString("mail");
}
rs.close();
 String[] to = {t};
        ...
        String[] bcc = {usrid};
         ...
         int i=Db.Insert("Update user_phr_details set key1='"+otp+"' where  id='"+id2+"'");
...
//response.sendRedirect("OtpAuthentication.jsp");
    System.out.println("Update user_phr_details set key1='"+otp+"' where  id='"+id2+"'");
