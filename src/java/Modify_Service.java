 ...
 * @author mvinoth
 */
@WebServlet(urlPatterns = {"/Modify_Service"})
public class Modify_Service extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String query="Update provider_services set Service_name='"+S_Name+"',Service_Desc='"+S_Des+"',Amount='"+amount1+"' where S_No='"+id1+"'";
